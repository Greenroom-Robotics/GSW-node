...
/****************************************
  ...
  TEOS-10 file "gsw_internal_const.h"
...
/***************************
    ...
    file of the C version.
    ----------------------
    Data are accessed by a
    call to the struct
    member rather than by
    a call to an exposed,
    raw data member.
***************************/

struct GSW_TEOS10_CONSTANTS
{
	...
	/** initialization */
	void init_GSW_TEOS10_CONSTANTS()
	{
		db2pa = 1.0e4;
		rec_db2pa = 1.0e-4;
		pa2db = 1.0e-4;
		...
		gsw_soncl = 1.80655; /** SP to Chlorinity ratio [(g/kg)^-1] */
		gsw_valence_factor = 1.2452898; /** valence factor of sea salt of Reference Composition [unitless] */
		/** gsw_atomic_weight: mole-weighted atomic weight of sea salt of Reference Composition [g/mol] */
...
struct GSW_SPECVOL_COEFFICIENTS
{
	...
	double  a000,a001,a002,a003,a004,a010,a011,a012,
			  ...
			  a112,a120,a121,a122,a130,a131,a140,a200,
			  a201,a202,a210,a211,a212,a220,a221,a230,
			  a300,a301,a302,a310,a311,a320,a400,a401,
			  a410,a500;

	/** 'b' series */
	double  b000,b003,b004,b010,b013,b020,b030,b040,
			  b050,b100,b103,b110,b120,b130,b140,b200,
			  b210,b220,b230,b300,b310,b320,b400,b410,
			  b500,b001,b011,b021,b031,b041,b101,b111,
			  b121,b131,b201,b211,b221,b301,b311,b401,
			  b002,b012,b022,b032,b102,b112,b122,b202,
			  b212,b302;

	/** 'c' series */
	double  c000,c001,c002,c003,c004,c005,c010,c011,
			  c012,c013,c020,c021,c022,c030,c031,c040,
			  c041,c050,c100,c101,c102,c103,c110,c111,
			  c112,c120,c121,c130,c131,c140,c200,c201,
			  c202,c210,c211,c220,c221,c230,c300,c301,
			  c310,c311,c320,c400,c401,c410,c500;

	/** 'h' series */
	double  h001,h002,h003,h004,h005,h006,h007, h011,
			  h012,h013,h014,h015,h021,h022,h023,h024,
			  h031,h032,h033,h042,h043,h041,h051,h052,
			  h061,h101,h102,h103,h104,h105,h111,h112,
			  h113,h114,h121,h122,h123,h131,h132,h133,
			  h141,h142,h151,h201,h202,h203,h204,h211,
			  h212,h213,h221,h222,h223,h231,h232,h241,
			  h301,h302,h303,h311,h312,h313,h321,h322,
			  h331,h401,h402,h403,h411,h421,h412,h501,
			  h502,h511,h601;

	/** 'v' series */
	double  v000,v001,v002,v003,v004,v005,v006,v010,
			  v011,v012,v013,v014,v020,v021,v022,v023,
			  v030,v031,v032,v040,v041,v042,v050,v051,
			  v060,v100,v101,v102,v103,v104,v110,v111,
			  v112,v113,v120,v121,v122,v130,v131,v132,
			  v140,v141,v150,v200,v201,v202,v203,v210,
			  v211,v212,v220,v221,v222,v230,v231,v240,
			  v300,v301,v302,v310,v311,v312,v320,v321,
			  v330,v400,v401,v402,v410,v411,v420,v500,
			  v501,v510,v600;

	/** initialization */
	void init_GSW_SPECVOL_COEFFICIENTS()
	{
		/** 'a' series */
...
struct GSW_FREEZING_POLY_COEFFICIENTS
{
	double a,b,c0,c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,
...
struct GSW_GIBBS_ICE_COEFFICIENTS
{
	/**
	1./Pt, where Pt; 611.657;
	Experimental triple-point pressure in Pa.
	*/
	double  rec_pt,tt,rec_tt,g00,g01,g02,g03,g04;

	void init_GSW_GIBBS_ICE_COEFFICIENTS()
	{
